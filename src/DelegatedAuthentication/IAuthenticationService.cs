...
namespace WorldDomination.DelegatedAuthentication
{
    ...
    /// <typeparam name="TAuthenticationOptions">IAuthenticationOptions: some custom options that are need for you to help check/store this user into your db.</typeparam>
    /// <typeparam name="TUser">Your user/account.</typeparam>
    public interface IAuthenticationService<out TSourceJwt, in TCustomJwt, TAuthenticationOptions, TUser>
